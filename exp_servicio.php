<?php
	...
	$cabecera= array("Item","Nombre Servicio","Precio Unitario","Tipo Servicio","Estado");
?>
<html>
<head>
...
<body>
	<table>
	<tr>
	<td colspan='7'><b>Listado de Servicio</b></td>
	</tr>
	<tr><td>&nbsp;</td></tr>	
	...
	try{
		...
		$cont=0;
		$cad ="select
                a.id_servicio,a.nom_servicio,a.precio_unitario,a.id_tiposervicio,a.estado
			    from servicio a";
