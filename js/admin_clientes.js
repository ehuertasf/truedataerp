...
Ext.onReady(function(){
	...
	function exportar_xls(){
		...
		var idusuario	=Ext.getDom('idusuario').value;
		document.location='exp_clientes.php?usuario='+login+'&idusuario='+idusuario;
	}	
	...
	var grid = new Ext.grid.GridPanel({
	    ...
	    columns:[
		        { id:'idcliente',header: "idcliente",width: 100 ,sortable: false,groupable: false,dataIndex:'idcliente',hidden:true}, 	
		        	{ header: "C&oacute;digo",width: 80,sortable: true,dataIndex: 'codigo_cliente',align:'left'},
		        	{ header: "Departamento",width: 80,sortable: true,dataIndex: 'departamento',groupable:false},
		        	{ header: "Ciudad",width: 80,sortable: true,dataIndex: 'ciudad',groupable:false,hidden:true},
		        	{ header: "Distrito",width: 120,sortable: true,dataIndex: 'distrito',groupable:false},
		        	{ header: "Nombre",width: 200,sortable: true,dataIndex: 'nombre',groupable:true,align:'left'},		        			        	
		        	{ header: "RUC",width: 100,sortable: true,dataIndex:'ruc', align:'center',groupable:true},		        	
		        	{ header: "DNI",width: 60,sortable: true,dataIndex:'dni', align:'center',groupable:true,hidden:true},		        	
		        	{ header: "Tel&eacute;fono I",width: 60,sortable: true,dataIndex: 'telefono_1',groupable:false,align:'center'},		        	
		        	{ header: "Tel&eacute;fono II",width: 60,sortable: true,dataIndex: 'telefono_2',groupable:false,align:'center',hidden:true},		        	
		        	{ header: "E-mail",width: 70,sortable: true,dataIndex: 'email',groupable:false,hidden:true},
		        	{ header: "Direcci&oacute;n I",width: 150,sortable: true,dataIndex: 'direccion',groupable:false},
		        	{ header: "Contacto",width: 80,sortable: true,dataIndex: 'contacto',groupable:false,hidden:true},
		        	{ header: "Estado",width: 55,sortable: true,dataIndex: 'estado',groupable:false,hidden:visible},
		        	{ header: "Direcci&oacute;n II",width: 55,sortable: true,dataIndex: 'direccion2',groupable:false,hidden:true},
		        	{ header: "Direcci&oacute;n III",width: 55,sortable: true,dataIndex: 'direccion3',groupable:false,hidden:true},
		        	{ header: "Direcci&oacute;n IV",width: 55,sortable: true,dataIndex: 'direccion4',groupable:false,hidden:true},
		        	{ header: "Observaciones",width: 55,sortable: true,dataIndex: 'observaciones',groupable:false,hidden:true}
	    ],
	...
	function nuevo_producto(){		
		llama_formulario('NUEVO CLIENTE','nuevo');	    
		Ventana_modal.show();			
	}
	...
	function recargar_grid(){
	   	store1.proxy= new Ext.data.HttpProxy({url: 'p_lista_clientes.php?n=1'});
	  	store1.load();    		
		Ext.get("v1").focus();
		view.startCollapsed=true;			
	}
	...
	var Ventana = new Ext.Window({
		title: 'MODULO -> MANTENIMIENTO DE CLIENTES',
		width: 1000,
		autoHeight:450,
		minWidth: 300,
		minHeight: 150,
