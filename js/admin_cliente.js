...
Ext.onReady(function(){
	...
	function exportar_xls(){
		...
		var idusuario	=Ext.getDom('idusuario').value;
		document.location='exp_cliente.php?usuario='+login+'&idusuario='+idusuario;
	}	
	
	var store1= new Ext.data.GroupingStore({
	    proxy: new Ext.data.HttpProxy({
	        url: 'p_lista_cliente.php?n=1'
	    }),
	...
	var grid = new Ext.grid.GridPanel({
	    ...
	    view: view,
	    columns:[
		        { id:'id_cliente',header: "id_cliente",width: 100 ,sortable: false,groupable: false,dataIndex:'id_cliente',hidden:true},
                ...
                { header: "Telefono Casa",width: 80,sortable: true,dataIndex: 'telefono_casa',groupable:false},
                { header: "Telefono Celular",width: 80,sortable: true,dataIndex: 'telefono_celular',groupable:false},
                { header: "Telefono Trabajo",width: 80,sortable: true,dataIndex: 'telefono_trabajo',groupable:false},
                { header: "Zonal",width: 80,sortable: true,dataIndex: 'id_zonal',groupable:false},
                { header: "Ciudad",width: 80,sortable: true,dataIndex: 'id_ciudad',groupable:false},
                { header: "Pais",width: 80,sortable: true,dataIndex: 'id_pais',groupable:false},
                { header: "Tipo Abonado",width: 80,sortable: true,dataIndex: 'tipo_abonado',groupable:false},
                { header: "Email",width: 80,sortable: true,dataIndex: 'email',groupable:false},
	...
	function Buscar(){
		...
		if(txtBuscado.validate()==true){
	    	store1.proxy= new Ext.data.HttpProxy({url: 'p_lista_cliente.php?n=2&buscar='+buscar});
	    	store1.load();
	    	Ext.get("v1").focus();
	...
	function recargar_grid(){
	   	store1.proxy= new Ext.data.HttpProxy({url: 'p_lista_cliente.php?n=1'});
	  	store1.load();    		
		Ext.get("v1").focus();
		view.startCollapsed=true;			
	}
