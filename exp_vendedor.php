<?php
	...
	$cabecera= array("Item","Ap. Paterno","Ap. Materno","Nombres","Direccion","DNI","Fecha Nacimiento","Fecha Ingreso","Telefono Fijo","Telefono Celular 1","Telefono Celular 2","Estado");
    ?>
<html>
<head>
...
<body>
	<table>
	<tr>
	<td colspan='7'><b>Listado de Vendedor</b></td>
	</tr>
	<tr><td>&nbsp;</td></tr>	
