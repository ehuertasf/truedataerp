<?php
	...
	$cabecera= array("Item","Ap. Paterno","Ap. Materno","Nombres","Usuario","Clave","DNI","Fecha Ultimo Ingreso","Fecha Ingreso","Sesion","Estado");
...
<body>
	<table>
	<tr>
	<td colspan='7'><b>Listado de Usuario</b></td>
	</tr>
	<tr><td>&nbsp;</td></tr>	
	...
	try{
		...
		$cont=0;
		$cad ="select
                    a.id_user,a.ap_paterno,a.ap_materno,a.nombre,a.usuario,a.clave,a.dni,a.fec_ultimo_ingreso,a.idsess,a.estado
