<?php
	...
	header("Content-Disposition: attachment; filename=BANDEJA_ASIGNACIONES.xls");
	...
	<table>
        <tr>
            <td colspan='7' style="font-family: Tahoma, Verdana; font-size:10px;"><b>Listado de Bandeja de Asignaciones</b></td>
        </tr>
        <tr>
    ...
    try{
        ...
        $cad ="select a.id_pedido,f.desc_estado,a.f_reg_ped,concat(b.ap_paterno,' ',b.ap_materno,', ',b.nombre) as nombre,
            ...
            and a.id_estado=f.id_estado and a.id_estado=1
            order by 2";
