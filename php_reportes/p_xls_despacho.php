<?php
	...
	header("Content-Disposition: attachment; filename=BANDEJA_DESPACHO.xls");
	...
	$cabecera= array("Item","N&uacute;m. Pedido","Estado del Pedido","Fecha Registro","Cliente","Direcci&oacute;n de Instalaci&oacute;n",
					"T&eacute;cnico Asignado","Fecha Programada","Servicio Adquirido");
    ?>
	<table>
        <tr>
            <td colspan='7' style="font-family: Tahoma, Verdana; font-size:10px;"><b>Listado de Bandeja de Despacho</b></td>
        </tr>
        <tr>
    ...
    try{
        ...
        $cad ="select a.id_pedido,h.desc_estado,a.f_reg_ped,concat(b.ap_paterno,' ',b.ap_materno,', ',b.nombre) as nombre,
            ...
            concat(g.ap_paterno,' ',g.ap_materno,', ',g.nombres) as nom_tecnico,a.f_prg_ped,i.nom_servicio
            ...
            and a.id_estado in (3,4) and f.id_estado=3 and f.id_tecnico=g.id_tecnico
            order by 2";
        ...
        ?>
            <tr>
                ...
                <td align='left' style="font-family: Tahoma, Verdana; font-size:10px;"><?=$row["f_prg_ped"]?></td>
