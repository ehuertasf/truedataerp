			...
			switch($n){
				case 1:
					...
					try{
						...
						$sql ="select count(*)	from tipo_servicio";
					...
					if($filas != 0) {
						$sqlquery1 ="select
                            a.id_tiposervicio,a.nom_tiposervicio, a.estado
				...
				case 2:
					...
					try{
						$sqlquery1 ="select 
							a.id_tiposervicio,a.nom_tiposervicio, a.estado
							from tipo_servicio a
							where (a.nom_tiposervicio like :buscar or a.id_tiposervicio like :buscar)";
				...
				case 3:		//muestro los detalles del cliente en un modal
					...
					try{
						$sqlquery1 ="select
                            a.id_tiposervicio,a.nom_tiposervicio, a.estado
							from tipo_servicio a
							where a.id_tiposervicio =:buscar";
