<?php
	...
	$cabecera= array("Item","Nombre Tap","Direccion","Direccion Referencial","Cant Borne",
    "Latitud","Longitud","Fecha Instalacion","Numero Serie","Modelo","Marca");
?>
<html>
<head>
<title>Lista de Taps</title>
</head>
<body>
	<table>
	<tr>
	<td colspan='7'><b>Listado de taps</b></td>
	</tr>
	<tr><td>&nbsp;</td></tr>	
	...
	try{
		...
		$cont=0;
		$cad ="select
                a.id_tap,a.nom_tap,a.cant_borne,a.direccion,a.direccion_referencial,
                            a.longitud,a.latitud,a.fec_instalacion,a.num_serie,a.id_modelo,a.id_marca
			from tap a";
